...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/Users/user1/OneDrive/Documents/Txtfiles/lotto5in.txt"));
             PrintStream ps = new PrintStream(("C:/Users/user1/OneDrive/Documents/Txtfiles/lotto5out.txt"), StandardCharsets.UTF_8)) {

                 final int LOTTO_SIZE = 5;
                 int[] inputNumbers = new int[49]; //max amount of numbers the user can give
                 int pivot = 0;
